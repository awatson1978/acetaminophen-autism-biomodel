...
% 1. AUTISM IDEOGRAM - Insert AFTER line ~50-55
% Location: Section 3.1 (Results - Genetic Architecture of Autism)
% INSERT AFTER this text:
% "    \item Critical genes include \textit{CHD8}, \textit{SHANK3}, \textit{FMR1}, and neurexin/neuroligin families"
% "\end{itemize}"
% BEFORE the existing placeholder microscopic figure
...
% 2. MECHANISTIC PATHWAYS - Insert AFTER line ~68-70
% Location: Beginning of Section 3.2 (Mechanistic Model of Action)
% INSERT AFTER: "\subsection{Mechanistic Model of Action}"
% and AFTER: "Emerging evidence suggests that prenatal APAP perturbs multiple biological pathways..."
% BEFORE: "\subsubsection{Oxidative Stress and Mitochondrial Dysfunction}"
...
% 3. GREY-WHITE MATTER - Insert AFTER line ~85-88
% Location: Section 3.2.4 (Oligodendrocyte Toxicity and Myelination)
% INSERT AFTER: "Mixed glial cultures exposed to APAP show up to 90\% oligodendrocyte precursor cell (OPC) death at 20 mM..."
% and AFTER: "Rodent studies show reduced BDNF and autism-like social behaviors..."
...
% 4. MYELINATION SANKEY - Also in Section 3.2.4
% INSERT immediately after the GreyWhiteMatter figure
...
% 5. EVIDENCE SUMMARY - Insert AFTER line ~108-110
% Location: After Section 4 (Evidence Synthesis) table
% INSERT AFTER the table ending with "\end{table}"
...
% 6. SPONGE MODEL - Insert AFTER line ~115-118
% Location: Section 5.1 (BioModel: Conceptual Foundation)
% INSERT AFTER: "We present a cellular automata model for myelination..."
% BEFORE Section 5.2 (Core Differential Equations)
...
% 7. FETAL DEVELOPMENT TIMELINE - Insert AFTER line ~135-140
% Location: Section 5.3 (Critical Windows and Susceptibility)
% INSERT AFTER the bullet points about susceptibility windows
% "    \item Late gestation (gliogenesis/myelination; $\partial O/\partial \tau$ maximal)"
% "\end{itemize}"
...
% 8. FETAL MRI COMPARISON - Also in Section 5.3
% INSERT immediately after the fetal-development figure
